...
char* ecvt(register double arg, int ndigits, int* decpt, int* sign)
{
...
char* ecvt_r(register double arg, int ndigits, int* decpt, int* sign, char* buf)
{
    if (ndigits > 17) {
	    register char *p, *e;
...
char* fcvt(register double arg, int ndigits, int* decpt, int* sign)
{
#ifndef _LIBC_NONSHARED
    if ((buffer == 0) && ((buffer = (char *)calloc(1, NDIG+2)) == 0))
	    return 0;
...
char* fcvt_r(register double arg, int ndigits, int* decpt, int* sign, char* buf)
{
...
char* qecvt(long double arg, int ndigits, int* decpt, int* sign)
{
#ifndef _LIBC_NONSHARED
    if ((buffer == 0) && ((buffer = (char *)calloc(1, NDIG+2)) == 0))
	    return 0;
...
char* qecvt_r(long double arg, int ndigits, int* decpt, int* sign, char* buf)
{
    if (ndigits > 34) {
	    register char *p, *e;
...
char* qfcvt(long double arg, int ndiits, int* decpt, int* sign)
{
#ifndef _LIBC_NONSHARED
    if ((buffer == 0) && ((buffer = (char *)calloc(1, NDIG+2)) == 0))
	    return 0;
...
char* qfcvt_r(long double arg, int ndigits, int* decpt, int* sign, char* buf)
{
