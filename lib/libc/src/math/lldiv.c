...
static unsigned ll_firstbit(llvalue number)
{
  unsigned bias = 0;
...
extern longlong_t __ll_div(longlong_t left, longlong_t right)
{
    llvalue a,b,q,r;
...
extern ulonglong_t __ull_div(ulonglong_t left, ulonglong_t right)
{
    llvalue a,b,q,r;
	llvalue ll_2_16, ll_2_53;
	a.ull = left;
...
extern longlong_t __ll_rem(longlong_t left, longlong_t right)
{
    llvalue a,b,q,r;
	llvalue ll_2_16, ll_2_53;
	int negate = 0;
...
extern ulonglong_t __ull_rem(ulonglong_t left, ulonglong_t right)
{
    llvalue a,b,q,r;
	llvalue ll_2_16, ll_2_53;
	a.ll = left;
...
extern longlong_t __ll_mod(longlong_t left, longlong_t right)
{
