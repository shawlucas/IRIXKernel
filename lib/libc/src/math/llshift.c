...
extern longlong_t __ll_lshift(longlong_t left, longlong_t right)
{
    llvalue a, b, r, mask;
...
extern longlong_t __ull_rshift(ulonglong_t left, longlong_t right)
{
    llvalue a, b, r, mask;
...
extern longlong_t __ll_rshift(longlong_t left, longlong_t right)
{
    llvalue a, b, r, mask;
