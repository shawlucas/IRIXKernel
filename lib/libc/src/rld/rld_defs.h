...
#if (_MIPS_SZPTR == 64)
#define __64BIT_OBJECTS
#endif

typedef uint64_t ADDR64;	    /* generic 64-bit virtual address */
...
typedef long long	ELF_SXWORD; /* These three should never be used in */
...
#define SIGNED	int32_t		    /* used for casting pointer to integer */
